                    ...
                    <div class="column is-half is-offset-3">
                        <div class='card'>
                            ...
                            <div class='card-content'>
                                <div class='columns is-half'>
                                    <div class='column'>
                                        <a class='button is-primary is-outlined is-fullwidth' href="{{ route('institutions.volunteer', auth()->user()->institution_id) }}">
                                            View Volunteers
                                        </a>
                                    </div>
                                    <div class='column'>
                                        <a class='button is-fullwidth' href="{{ route('institutions.create.volunteer', auth()->user()->institution) }}">
                                            Create Volunteer
                                        </a>
                                    </div>
                                </div>
